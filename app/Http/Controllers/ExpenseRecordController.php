...
class ExpenseRecordController extends Controller
{
    public function getfiltered(Request $request)
    {
        ...
        $query = DB::table('expense_record')->select("expense_record.id", "concept", "appuser_account.name", "notes", "amount", DB::raw("category_expense.name as categoryname"), DB::raw("expenserecord_date as record_date"))
