...
export default function SectionperiodicDetails({ listcategoryincome, listappuseraccounts, data, setData }:
    { listcategoryincome: SelectCategoryItem[], listappuseraccounts: SelectAppUserAccountItem[], data: FormPeriodicIncomeRecord, setData: any }) {
    return (
        <>
            <div className="flex gap-6 mb-4">
                ...
                <div>
                    <BrandInputForm type="number" onChange={(e) => { setData("input-income_frequency", parseFloat(e.currentTarget.value)) }} defaultValue={data["input-income_frequency"]}>Dias de Frecuencia</BrandInputForm>
                </div>
            ...
            <div className="flex gap-6 mb-4">
                ...
                <div>
                    <BrandSelectForm label="Categoria" name="select-categoryincome_id" value={data["select-categoryincome_id"]} onChange={(e) => { setData("select-categoryincome_id", e.currentTarget.value) }}>
