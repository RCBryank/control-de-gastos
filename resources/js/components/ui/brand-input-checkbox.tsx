    ...
    return (
        <>
            <div className="flex cursor-pointer" onClick={() => SetChecked(!checked)}>
                ...
                <div className={"bg-gray-100 relative overflow-hidden inline-block w-6 aspect-square border-[1px] rounded-sm cursor-pointer " + (checked ? "border-none" : "border-gray-400")}>
