...
const WebAppLayout = ({ children }: { children: ReactNode }) => {
    return (<div className="bg-brand-background min-h-screen">
        <AppTopbar>
            ...
            <MenuItemTopbar selected={window.location.pathname == '/metasdeahorro'} href="/metasdeahorro">Metas de Ahorro</MenuItemTopbar>
...
WebAppLayout.layout = (page: any) => <WebAppLayout children={page}></WebAppLayout>
