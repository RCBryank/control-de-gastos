...
export default function NewPeriodicIcnome() {
                    ...
                    <div className="bg-brand-white rounded-md p-12">
                        ...
                        <form onSubmit={OnSubmitHandler}>
                            <div className="flex gap-6 mb-4">
                                ...
                                <div>
                                    <BrandInputForm type="number" onChange={(e) => { setData("input-income_frequency", parseFloat(e.currentTarget.value)) }} defaultValue={1}>Dias de Frecuencia</BrandInputForm>
                                </div>
                            ...
                            <div className="flex gap-6 mb-4">
                                ...
                                <div>
                                    <BrandSelectForm label="Categoria" name="select-categoryincome_id" onChange={(e) => { setData("select-categoryincome_id", e.currentTarget.value) }}>
